...
#if LDOUBLE 
/* Coprocessor initialization function,
...
#ifdef PIC_TEST
// =====================================================
// Include PIC simulator test code and defines
#include "picfp.c"
// =====================================================
#else
#define NE 6
#define FLOAT(x) unsigned short x[NE] = {0}
extern unsigned short eone[];
#endif

#endif	/* not NATIVE */

/* einit() {} */  /* null coprocessor initialization */
...
{
#ifdef PIC_TEST
// Start the PIC simulator with the floating point test file
    if(argc > 0)
        pic_init(argv[1]);
#endif
